...
import { User, Edit, Settings, Shield, MapPin, Calendar, Fish } from 'lucide-react';
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <button className="w-full text-left p-3 rounded-lg hover:bg-red-900/20 hover:text-red-400 transition-colors">
              <div className="flex items-center justify-between">
