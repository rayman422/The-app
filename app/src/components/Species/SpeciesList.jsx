...
export const SpeciesList = ({ setPage }) => (
  <div className="bg-slate-900 p-4 min-h-screen pb-20">
    ...
    >
      ...
      <h2 className="text-white text-xl font-semibold mb-2">Species Database Coming Soon</h2>
      <p className="text-gray-400">
        Comprehensive species information and your catch history will be here.
      </p>
    </motion.div>
  </div>
);