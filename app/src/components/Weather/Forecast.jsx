...
export const Forecast = ({ setPage }) => (
  <div className="bg-slate-900 p-4 min-h-screen pb-20">
    ...
    >
      <CloudSun size={64} className="mx-auto text-gray-500 mb-4" />
      <h2 className="text-white text-xl font-semibold mb-2">Weather Integration Coming Soon</h2>
      <p className="text-gray-400">
        Real-time weather, tides, and fishing conditions will be available here.
      </p>
    </motion.div>
  </div>
);